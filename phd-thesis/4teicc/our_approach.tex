...
\begin{figure}[ht!]
\centering
\lstinputlisting[language=Java,label={lst:test1}]{mysnippets/slice.java}
\label{fig:slices}
...
\lstinputlisting[language=Java,label={lst:slices}, caption={Extracted and Refined Slice}]{mysnippets/slice.java}
