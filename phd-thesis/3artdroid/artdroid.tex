...
%\begin{figure}[h!]
%\lstinputlisting[language=C++]{listings/class.h}
...
%\begin{figure}[h!]
%\lstinputlisting[language=C++]{listings/art-method.h}
...
%\begin{figure}[h!]
%\lstinputlisting[language=Java]{listings/testcode.java}
%\caption{Call to method getDeviceId} 
%\label{fig:es1}
%\end{figure}

%\begin{figure}[h!]
%\lstinputlisting{listings/compiledcode.txt}
...
%   \caption{ARTDroid not enabled}
%   \label{fig:design1} 
%	\end{subfigure}
%	
%	\begin{subfigure}[b]{\columnwidth}
%   \includegraphics[width=\columnwidth]{design2}
%   \caption{ARTDroid enabled}
%   \label{fig:design2}
%\end{subfigure}
...
%\begin{figure}[ht]
%\begin{center}
%\lstinputlisting[language=xml]{listings/config.json}
...
%\begin{figure}[ht]
%\begin{center}
%\lstinputlisting[language=Java]{listings/patch-code.java}
